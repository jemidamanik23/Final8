...
<header class="main-header bg-placeholder">
    <div class="container-fluid">
        <nav class="navbar navbar-dark navbar-expand-lg">
            <a href="{{ route('post.index') }}" id="blog-navbar-brand" class="navbar-brand">Medium <br>Indonesia
            </a>
            ...
            <div class="navbar-collapse collapse" id="blog-navbar-collapse">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="{{ route('archives') }}">ARCHIVE</a></li>
                ...
                <ul class="nav navbar-nav ml-auto justify-content-end">
                    <form class="form-inline" role="search" method="get" action="{{ route('search') }}">
                        <input type="text" class="form-control" name="q" placeholder="CARI" required>
                    </form>
                    @if(Auth::check())
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="{{ route('user.show', $user->name) }}">CENTER</a>
