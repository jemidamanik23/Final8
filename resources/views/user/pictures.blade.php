        ...
        <div class="p-3">
            <form method="post" action="{{ route('user.update.avatar') }}"
                ...
                <div class="form-group">
                    <label class="control-label">CHANGE_USER_IMG ：</label>
                ...
                <button class="btn btn-outline-success" id="upload-button" type="submit">CHANGE_USER_IMG</button>
            </form>
            ...
            <form class="mt-3" method="post" action="{{ route('user.update.profile') }}"
                ...
                <button class="btn btn-outline-success" id="upload-button" type="submit">CHANGE_INFO_IMG</button>
            </form>
        </div>
    @endcan
@endsection
