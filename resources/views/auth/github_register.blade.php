            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-github fa-fw"></i>SIGN_UP
                    </div>
                    <div class="card-body">
                        <form class="col-md-6" method="POST" action="{{ route('github.store') }}">
                            ...
                            <div class="form-group">
                                <label for="name" class="form-control-label">NICK_NAME</label>
                            ...
                            <div class="form-group">
                                <label for="password-confirm" class="form-control-label">CONFIRM_PASSWORD</label>
