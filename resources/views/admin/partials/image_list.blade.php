            ...
            <div class="card img-container">
                ...
                <div class="img-overlay">
                    <div class="actions align-self-center text-center">
                        ...
                        <a class="text-white d-block" href="{{ $image->url }}">ORIGINAL_IMAGE</a>
                        ...
                        <a class="text-danger d-block swal-dialog-target" href="javascript:void(0)"
                           data-dialog-msg="{CONFIRM_TO_REMOVE}{{ $image->name }}？"
                           data-url="{{ route('delete.file').'?key='.$image->key.'&type=image' }}"
                           data-key="{{ $image->key }}">REMOVE</a>
                    </div>
                </div>
            </div>
        </div>
    @empty
        <h4 class="text-secondary mt-3">NO IMAGE</h4>
    @endforelse
</div>
