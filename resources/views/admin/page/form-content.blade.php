<div class="form-group">
    <label for="name" class="form-control-label">FORM_CONTENT_URI*</label>
...
<div class="form-group">
    <label for="content" class="form-control-label">FORM CONTENT*</label>
...
<div class="collapse" id="page-extra-info">
    <div class="form-group">
        <label for="comment_info" class="form-control-label">COMMENT MESSAGE</label>
        <select style="margin-top: 5px" id="comment_info" name="comment_info" class="form-control">
            ...
            <option value="force_disable" {{ $comment_info=='force_disable'?' selected' : '' }}>DISABLE</option>
            <option value="force_enable" {{ $comment_info=='force_enable'?' selected' : '' }}>ENABLE</option>
        </select>
    </div>
    <div class="form-group">
        ...
        <select id="comment_type" name="comment_type" class="form-control">
            ...
            <option value="raw" {{ $comment_type=='raw'?' selected' : '' }}>COMMENT RAW</option>
    ...
    <div class="form-group">
        ...
        <select id="allow_resource_comment" name="allow_resource_comment" class="form-control">
            ...
            <option value="false" {{ $allow_resource_comment=='false'?' selected' : '' }}>DISALLOW COMMENT</option>
            <option value="true" {{ $allow_resource_comment=='true'?' selected' : '' }}>ALLOW COMMENT</option>
        </select>
    </div>
</div>
