            ...
            <form id="comment-form" method="post" action="{{ route('comment.store') }}" class="comment-form">
                ...
                @if(!auth()->check())
                    <div class="form-group">
                        ...
                        <input {{ $final_allow_comment?' ':' disabled ' }} class="form-control" id="username" type="text" name="username" placeholder="YOUR_NAME">
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" for="email">EMAIL<span class="text-danger">*</span></label>
                        <input {{ $final_allow_comment?' ':' disabled ' }} class="form-control" id="email" type="email" name="email" placeholder="YOUR_EMAIL">
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" for="site">WEBSITE</label>
                        <input {{ $final_allow_comment?' ':' disabled ' }} class="form-control" id="site" type="text" name="site" placeholder="YOUR_WEBSITE">
                    </div>
                @endif
                <div class="form-group">
                    <label for="comment-content">COMMENT_ARTICLE ,SUPPORT<a href="https://daringfireball.net/projects/markdown/syntax">Markdown</a><span class="text-danger">*</span></label>
                    <textarea {{ $final_allow_comment?' ':' disabled ' }} placeholder="REVIEW_N_SHOW"
